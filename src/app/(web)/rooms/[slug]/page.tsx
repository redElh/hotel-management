...
const RoomDetails = (props:{params:{slug:string}}) => {
  ...
  const [checkinDate,setChekinDate]=useState<Date | null>(null);

  const [checkoutDate,setChekoutDate]=useState<Date | null>(null);
  ...
  console.log(room?.offeredAmeneties);
          ...
          <div className="md:col-span-8 md:w-full">
            ...
            <div>
              ...
              <div className="flex my-11">
                {room.offeredAmeneties.map(amenety=> (
                  <div key={amenety._key} className="md:w-44 w-fit text-center px-2 md:px-0 h-20 md:h-40 mr-3 bg-[#eff0f2] dark:bg-gray-800 rounded-lg grid place-content-center">
                    <i className={`fa-solid ${amenety.icon} md:text-2xl`}></i>
              ...
              <div className="mb-11">
                ...
                <div className="grid grid-cols-2">
                  {room.offeredAmeneties.map(amenety=>(
                    <div key={amenety._key} className="flex items-center md:my-0 my-1">
                      <i className={`fa-solid ${amenety.icon}`}></i>
