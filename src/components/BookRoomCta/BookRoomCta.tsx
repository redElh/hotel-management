...
type Props={
  ...
  setChekinDate:Dispatch<SetStateAction<Date | null>>;
...
const BookRoomCta:FC<Props> = (props) => {
  ...
  return (  
    <div className="px-4 md:px-7 py-6">
      ...
      <div className="w-full border-b-4 border-b-secondary my-2"/>
      ...
      <div className="flex">
        <div className="w-1/2 pr-2">
          ...
          <DatePicker selected={checkinDate} onChange={date=>setChekinDate(date)} dateFormat="dd/MM/yyyy" minDate={new Date()} id="check-in-date" className="w-full border text-black border-gray-300 rounded-lg p-2.5 focus:ring-primary focus:border-primary"/>
        </div>
        ...
        <div className="w-1/2 pl-2">
          ...
          <DatePicker selected={checkoutDate} onChange={date=>setChekoutDate(date)} dateFormat="dd/MM/yyyy" disabled={!checkinDate} minDate={calcMinChekoutDate()} id="check-out-date" className="w-full border text-black border-gray-300 rounded-lg p-2.5 focus:ring-primary focus:border-primary"/>
        </div>
      </div>
