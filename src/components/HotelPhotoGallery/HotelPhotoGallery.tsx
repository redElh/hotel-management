      ...
      <div className="grid md:grid-cols-2 relative gap-5 px-20">
        ...
        <div className="hidden md:grid grid-cols-2 h-full gap-5">
          ...
          {remainingPhotosCount >=0 && 
            <div className="cursor-pointer relative h-64 rounded-2xl overflow-hidden bg-red-200" onClick={openModal.bind(this,maximumVisiblePhotos)}>
        ...
        {showModal &&
          <div className="fixed top-0 left-0 w-full h-full flex justify-center bg-black bg-opacity-90 z-[55]">
            <div className="h-[75vh] w-[320px] md:w-[700px] relative top-10">
