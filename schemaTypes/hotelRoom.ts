...
const hotelRoom={
  ...
  fields:[
    ...
    defineField({
      ...
      type:'text',
      validation:Rule => Rule.required(),
      initialValue:'Check-in time is 12.00 PM, checkout time is 11:59 AM. If you left behind any item, please contact the receptionist.',
    }),
    ...
    defineField({
      name:'offeredAmeneties',
      title:'Offered Ameneties',
      type:'array',
      of:[
        {
          type:'object',
